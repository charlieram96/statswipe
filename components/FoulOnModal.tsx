...
export const FoulOnModal: React.FC<FoulOnModalProps> = ({
  visible,
  onClose,
  onSelectPlayer,
  onSelectTeam,
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Who was fouled?</Text>
          ...
          <ScrollView style={styles.playerList} showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              <Text style={styles.teamIndicator}>Technical/General foul</Text>
            </TouchableOpacity>
          </ScrollView>
